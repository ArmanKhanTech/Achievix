...
import com.android.achievix.Activity.RestrictActivity;
...
public class RestrictedAppList extends Fragment {
    ...
    ListView lvv2;
    TextView tvvv2;
    private RestrictPackages db;
    private LimitPackages db2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        db2=new LimitPackages(getActivity());
    ...
    public void setButtonColor(){
        if(packages.size()>0){
            unrestrict.setBackground(getResources().getDrawable(R.drawable.restrict_button_theme));
        }
        else{
            unrestrict.setBackground(getResources().getDrawable(R.drawable.list_bg_theme));
        }
    }
